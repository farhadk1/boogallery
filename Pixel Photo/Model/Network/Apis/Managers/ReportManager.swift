...
class ReportManager{
    ...
    func reportPost(accessToken:String,postId:Int, completionBlock: @escaping (_ Success:ReportModel.ReportSuccessModel?,_ SessionError:ReportModel.SessionAndServerError?, Error?) ->()){
        ...
        Alamofire.request(API.POST_CONSTANT_METHODS.REPORT_POST_API, method: .post, parameters: params, encoding:URLEncoding.default, headers: nil).responseJSON { (response) in
